                ...
                <table id="dt-basic" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $d->kat_id ?></td>
                            
                            <td>
                                <a href="<?php echo base_url('v_blog/edit') ?>" class="btn btn-sm btn-outline-primary">Edit</a> 
                                <a href="<?php echo base_url('v_blog/delete')?>" class="btn btn-sm btn-outline-danger">Delete</a> 
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
